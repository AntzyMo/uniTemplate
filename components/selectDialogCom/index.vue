<template>
	<view class="cardDialog" v-if="visible" @touchmove.stop.prevent>
		<view class="content">
			<view class="c-header">
				<view class="flex1"><view class="close" @click="closeDialog">取消</view></view>
				<view class="flex1"><view class="title">{{title}}</view></view>
				<view class="flex1"><view class="close"></view></view>
			</view>

			<view class="c-content" >
				<scroll-view class="scroll-view"   scroll-y :scroll-into-view="scrollToName">
					<view class="item"
